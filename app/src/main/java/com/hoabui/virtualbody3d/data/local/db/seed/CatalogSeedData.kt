 ...
 * Exercise images are resolved at runtime from [ExerciseDto.name] via [com.hoabui.virtualbody3d.data.mapper.resolveDrawableNameFromExerciseLabel]
 * (and network URL when set). No [android.R] ids in seed rows.
 */
